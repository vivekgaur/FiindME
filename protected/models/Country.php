...
class Country extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tblAddresses' => array(self::HAS_MANY, 'TblAddress', 'country_id_fk'),
			'tblCities' => array(self::HAS_MANY, 'TblCity', 'country_id_fk'),
			'tblStates' => array(self::HAS_MANY, 'TblState', 'country_id_fk'),
		);
	}
